								...
								<?php foreach ($kelas as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('kelas/update/').$key->id ?>" class="btn btn-warning"><i class="glyphicon glyphicon-edit"></i>Edit</a>
											<a href="<?php echo site_url('kelas/delete/').$key->id ?>" type="button" class="btn btn-l
											"onclick="return confirm('Apakah Anda Yakin Ingin Hapus data?')" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a>
										</td>
									</tr>
